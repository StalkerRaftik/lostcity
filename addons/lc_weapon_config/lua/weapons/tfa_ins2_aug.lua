...
SWEP.Author				= "YuRaNnNzZZ & TFA" --Author Tooltip
...
SWEP.PrintName				= "AUG [Fourth SR]"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_AUG.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_AUG.2") -- This is the sound of the weapon, when silenced.
...
--Recoil Related
SWEP.Primary.KickUp = 0.93-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.78 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.32 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 0.79 --Amount of recoil to directly apply to EyeAngl
--Firing Cone Related
SWEP.Primary.Spread = .0009 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.64 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
SWEP.ProjectileEntity = nil --Entity to shoot
SWEP.ProjectileVelocity = 0 --Entity to shoot's velocity
SWEP.ProjectileModel = nil --Entity to shoot's model
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_aug.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_aug.mdl" -- Weapon world model path
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_aug.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
...
SWEP.WElements = {
	...
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup_aug.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
