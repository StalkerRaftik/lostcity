...
SWEP.PrintName			= "Самодельный дробовик [Homemade]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickHorizontal = 0.62 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 1.19 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
