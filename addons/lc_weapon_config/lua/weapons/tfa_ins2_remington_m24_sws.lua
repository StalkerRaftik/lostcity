...
SWEP.PrintName				= "Remington M24 SWS [Other Weapon]"	          -- Weapon name (Shown on HUD)
SWEP.Manufacturer           = "Remington Arms"                -- Gun Manufactrer (e.g. Hoeckler and Koch )          
SWEP.Type                   = "Bolt-Action Sniper Rifle"
SWEP.Purpose				= "An 7.62x51MM Bolt Action Sniper Rifle."   
SWEP.Instructions		    = ""    
...
SWEP.Primary.Ammo                = "12mmRound"    -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.VMPos                = Vector(-0.5, 1, 0.25)             -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
