...
SWEP.PrintName				= "Barrett M98B [DWZ Weapon]"	              -- Weapon name (Shown on HUD)
...
SWEP.Primary.KickDown            = 0.61                       -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.34                       -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor  = 0.582                      -- Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
-- Movespeed
SWEP.MoveSpeed                   = 0.78                       -- Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed         = 0.62                       -- Multiply the player's movespeed by this when sighting.
...
SWEP.VMPos                   = Vector(-0.1, 0, 0.1)           -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos_2XRDS     = Vector(-2.625, -3.3, 0.24)
...
SWEP.Attachments = {
	...
	[3] = { atts = { "ins2_br_heavy", "warface_m98b_short_barrel" } },
	...
	[8] = { atts = { "warface_m98b_flor_de_muerto_skin", "warface_m98b_pinky_skin" } },
}
