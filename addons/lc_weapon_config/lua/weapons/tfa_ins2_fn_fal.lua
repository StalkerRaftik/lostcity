...
SWEP.PrintName				= "FN FAL [DWZ Weapon]"		                   -- Weapon name (Shown on HUD)
SWEP.Manufacturer 			= "FN Herstal"                     -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Purpose				= "An Legendary 7.62x51MM Battle Rifle." 
SWEP.Instructions			= ""              
...
SWEP.Primary.KickDown            = 0.55                        -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.16                        -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor  = 0.56                        -- Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.VMPos          = Vector(-0.2, 0, -0.45)                   -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos_2XRDS  = Vector(-2.472, -2.25, -0.775)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)
SWEP.RTOverlayTransforms_2XRDS = { 0, -0.02 }

SWEP.IronSightsPos_C79       = Vector(-2.475, -1.7, -0.902)
SWEP.IronSightsAng_C79       = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X      = Vector(-2.4185, -2.2, -0.475)
SWEP.IronSightsAng_PO4X      = Vector(0, 0, 0)

SWEP.IronSightsPos_MX4       = Vector(-2.486, -0.5, -0.905)
