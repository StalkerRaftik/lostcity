...
SWEP.PrintName				= "SKS [Second SR]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickDown = 0.95 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.3 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 0.72--Amount of recoil to directly apply to EyeAngles.ge (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .00033--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00023 -- Ironsight accuracy, should be the same for shotguns
...
--Movespeed
SWEP.MoveSpeed = 0.795 --Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.687 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
