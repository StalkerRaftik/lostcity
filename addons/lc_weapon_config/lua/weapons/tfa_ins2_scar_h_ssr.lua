...
SWEP.PrintName				= "SCAR-H SSR [Other Weapon]"		               -- Weapon name (Shown on HUD)
SWEP.Manufacturer 			= "FN Herstal"                     -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Purpose				= "An modern tactical 7.62x51MM Battle Rifle."                 -- Purpose Tooltip
SWEP.Instructions			= ""              
...
SWEP.Primary.PenetrationMultiplier = 0.92                      -- Change the amount of something this gun can penetrate through
...
SWEP.Primary.KickDown            = 0.44                        -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.41                        -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor  = 0.78                        -- Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.

-- Firing Cone Related
SWEP.Primary.Spread              = 0.0383                      -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy        = 0.0012                      -- Ironsight accuracy, should be the same for shotguns

-- Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.

SWEP.Primary.SpreadMultiplierMax = 2.72                        -- How far the spread can expand when you shoot. Example val: 2.5
SWEP.Primary.SpreadIncrement     = 0.86                        -- What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery      = 5.25                        -- How much the spread recovers, per second. Example val: 3

-- Range Related
SWEP.Primary.Range               = 0.9 * (3280.84 * 16)        -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = {
		...
		{range = 400, damage = 1},
		{range = 400, damage = 1},
		{range = 900, damage = 0.9},
		{range = 900, damage = 0.9},
		{range = 900, damage = 0.9},
		{range = 1300, damage = 0.62},
	}
}
...
SWEP.IronSightsMoveSpeed         = 0.77                        -- Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel	    = "models/weapons/c_scar_h_ssr.mdl"        -- Viewmodel path
SWEP.VMPos          = Vector(-0.5, -0.5, 0.7)                  -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel	  = "models/weapons/w_scar_h_ssr.mdl" -- Weapon world model path
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/a_ironsight_scar_ssr.mdl", bone = "A_Optic", rel = "", pos = Vector(-2.723, 1.95, -12.5), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true},
	["rail_sights"] = { type = "Model", model = "models/weapons/a_ironsight_scar_ssr_mod.mdl", bone = "A_Optic", rel = "", pos = Vector(-2.723, 1.97, -12.7), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
