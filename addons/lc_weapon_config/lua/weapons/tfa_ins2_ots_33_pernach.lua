...
SWEP.PrintName				= "OTs-33 Pernach [DWZ Weapon]"                  -- Weapon name (Shown on HUD)
SWEP.Manufacturer           = "KBP Instrument Design Bureau"    -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Purpose				= "A Russian 9x18MM Automatic Pistol." 
SWEP.Instructions			= ""              
