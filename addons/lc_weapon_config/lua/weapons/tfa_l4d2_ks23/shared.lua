...
SWEP.PrintName				= "KS-23 [FBI Weapon]"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_KS23.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DamageType = bit.bor(DMG_BULLET,DMG_ALWAYSGIB,DMG_AIRBOAT) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
--Range Related
SWEP.Primary.Range = 3*25*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsMoveSpeed = 0.90*0.8 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_ks23.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_ks23.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.71, -5.498, 2.92)
SWEP.IronSightsAng = Vector(0.4, -0.02, 0.2)
--[[INSPECTION]]--

SWEP.InspectPos = Vector(8.019, -11, -4)
SWEP.InspectAng = Vector(39.611, 45.441, 20.899)
