...
SWEP.PrintName				= "AR-15 [Third SR]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Spread		= .00035	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
...
SWEP.IronSightsPos = Vector(-2.74, -1.293, 0.65)
SWEP.IronSightsAng = Vector(1, 0.05, 0)

SWEP.IronSightsPos_GL = Vector(-1.365, -0.61, 1.54)
SWEP.IronSightsAng_GL = Vector(1.5,-1.2,0)

SWEP.IronSightsPos_RDS = Vector(-2.735, -0.293, 0.72)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.729, -1.993, 0.72)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.73, -0.293, 0.72)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.73, -0.293, 0.95)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.71, -2.9, 0.3)
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-5, -0.8, -0.3), angle = Angle(180, 0, 0) },
...
SWEP.Attachments = {
	...
	[4] = { offset = { 0, 0 }, atts = { "ins2_fg_grip", "ins2_fg_m203" }, order = 4 },
	[5] = { offset = { 0, 0 }, atts = { "ar15_magpul_stock", "ar15_m16_stock" }, order = 6 },
	[6] = { offset = { 0, 0 }, atts = { "ins2_ub_laser" }, order = 7 },
	[7] = { offset = { 0, 0 }, atts = { "ar15_ext_mag_60" }, order = 5 },
	[8] = { offset = { 0, 0 }, atts = { "ar15_magpul_barrel", "ar15_m16_barrel", "ar15_ris_barrel", "ar15_ext_ris_barrel" }, order = 3 }
}
SWEP.AttachmentDependencies = {	["ins2_ub_laser"] = { "ar15_ris_barrel", "ar15_ext_ris_barrel" }, ["ins2_fg_m203"] = { "ar15_ris_barrel", "ar15_ext_ris_barrel" }	}--{["si_acog"] = {"bg_rail"}}
SWEP.AttachmentExclusions = { ["ins2_ub_laser"] = {"ar15_magpul_barrel", "ar15_m16_barrel"}, ["ins2_fg_m203"] = {"ar15_magpul_barrel", "ar15_m16_barrel"} }
