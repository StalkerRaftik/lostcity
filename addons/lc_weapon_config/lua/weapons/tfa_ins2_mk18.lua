...
SWEP.PrintName				= "MK18 [Fourth SR]"		-- Weapon name (Shown on HUD)
...
--Firing Cone Related
SWEP.Primary.Spread = .0013 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--Movespeed
SWEP.MoveSpeed = 0.675 --Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.61 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
