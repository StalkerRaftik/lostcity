...
SWEP.Category				= "LostCity Weapon MEDUSA" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer 			= "Kalashnikov Concern" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author					= "GroveZ" --Author Tooltip
...
SWEP.PrintName				= "AKS 74U [MEDUSA Weapon]"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.AKSZ.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.AKSZ.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_aksz.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_aksz.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.233, -2, 0.61)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.233, -3, -0.375)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 70

SWEP.IronSightsPos_EOTech = Vector(-2.233, -3, -0.385)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 75

SWEP.IronSightsPos_RDS = Vector(-2.233, -3, -0.595)
...
SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(0.55, 0.55, 0.55), pos = Vector(0, 1.5, 0), angle = Angle(0, 0, 0) },
	["A_Optic"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(0, -7.5, 0.25), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(-0.8, 1.5, 0.75), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(.75, .75, .75), pos = Vector(-2, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-3, 0.5, 0.65), angle = Angle(0, 0, -90) },
	["ATTACH_Foregrip"] = { scale = Vector(1.2, 1.2, 1.2), pos = Vector(0, 0, 0.5), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(8.8, 0, 0.65), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_aks.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_woodgrips_aksz.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail_sr25.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(-0.29, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0.5,-0.5,-0.75), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	
	["sight_pk122"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_pk122.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_pk122_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_pk122") or nil,
}
...
SWEP.WElements = {
	...
	["sight_pk122"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_pk122.mdl", bone = "ATTACH_ModKit", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_foregrip_aksz.mdl", bone = "ATTACH_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
