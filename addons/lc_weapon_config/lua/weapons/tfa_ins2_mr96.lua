...
SWEP.Author				    = "Xxyan700xX"            -- Author Tooltip
SWEP.Contact				= ""                      -- Contact Info Tooltip
SWEP.Purpose				= "A common light weight double action revolver." --Purpose Tooltip
...
SWEP.PrintName				= "MR-96 [First SR]"		          -- Weapon name (Shown on HUD)
...
-- Recoil Related
SWEP.Primary.KickUp          = 1.65     -- This is the maximum upwards recoil (rise)
...
SWEP.IronSightsPos = Vector(-1.853, 0, 1.1025)
...
SWEP.ViewModel		= "models/weapons/c_revolver_mr96.mdl" -- Viewmodel path
SWEP.VMPos          = Vector(0.05, 0.5, 0)  -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel		= "models/weapons/w_mr96.mdl" -- Weapon world model path
...
SWEP.Attachments = {
--	[1] = { atts = {"ins2_ub_laser"} },
	[1] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 1 },
	[2] = { offset = { 0, 0 }, atts = { "ins2_mag_speedloader" }, order = 1 },
}

SWEP.ViewModelBoneMods = {
--	["A_Underbarrel"] = { scale = Vector(1, 1, 1), pos = Vector(1, 0, 0), angle = Angle(0, 0, 0) },
	["A_Muzzle"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
...
--	["Weapon"] = { scale = Vector(1.05, 1.05, 1.05), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["Hammer"] = { scale = Vector(1.11, 1.11, 1.11), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["Cylinder_arm"] = { scale = Vector(1.11, 1.11, 1.11), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["Cylinder_release"] = { scale = Vector(1.11, 1.11, 1.11), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["Cylinder"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.05), angle = Angle(0, 0, 0) },
--	["Casing_1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
--	["Casing_2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
--	["Casing_3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
--	["Casing_4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
--	["Casing_5"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
--	["Casing_6"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0.1), angle = Angle(0, 0, 0) },
}
