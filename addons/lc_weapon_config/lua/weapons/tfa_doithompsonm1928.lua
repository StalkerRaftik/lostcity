...
SWEP.PrintName				= "Thompson M1928 [DWZ Weapon]"		-- Weapon name (Shown on HUD)
...
SWEP.WorldModel				= "models/weapons/tfa_doi/w_thompson1928.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.KickUp				= 0.73				-- Maximum up recoil (rise)
