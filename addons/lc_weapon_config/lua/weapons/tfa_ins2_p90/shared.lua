...
SWEP.Author				= "Meme" --Author Tooltip
SWEP.Contact				= "http://steamcommunity.com/id/svennebananguy/" --Contact Info Tooltip
SWEP.Purpose				= "Shoost bad guy in face" --Purpose Tooltip
...
SWEP.PrintName				= "P90 [DWZ Weapon]"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_P90.1")
SWEP.Primary.SilencedSound = Sound("TFA_INS2_P90.2")
...
--Range Related
SWEP.Primary.Range = 1 * 48 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_p90.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 80		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(-0.5,1,0.1) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_p90.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.6285, -3, -0.127)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.632, -3.5, -0.804)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech =  Vector(-3.631, -3.5, -1.012)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.630, -3.5, -1.012)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Suppressor"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.4, 0), angle = Angle(0, 0, 0) },
	["A_Underbarrel"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(-0.1, 1, 0), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(-0.55, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.8, 0.2), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 1), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(-0.5, 2.71, 1.5), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0,0,-1.2), angle = Angle(0, -1.2, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false }
}
...
[1] = { offset = { 0, 0 }, atts = { "ins2_br_supp" }, order = 1 },
	...
	[6] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds"}, order = 2 },
}
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ ["time"] = 90 / 31.5, ["type"] = "lua", ["value"] = function(self)
			self.Bodygroups_V[ self.BeltBG ] = math.Clamp( self:Ammo1() + self:Clip1(), 0, self.BeltMax )
		end}
	},

	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 65 / 31.5, ["type"] = "lua", ["value"] = function(self)
			self.Bodygroups_V[ self.BeltBG ] = math.Clamp( self:Ammo1() + self:Clip1(), 0, self.BeltMax )
		end}
	}
}
