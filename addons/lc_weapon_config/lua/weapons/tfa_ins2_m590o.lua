...
SWEP.PrintName				= "M590A1 [Third SR]"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_M590_OLLI.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_M590_OLLI.2") -- This is the sound of the weapon, when silenced.
...
--Recoil Related
SWEP.Primary.KickUp				= 1.66			-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.68		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.028		-- Maximum up recoil (stock)
SWEP.Primary.StaticRecoilFactor = 2.25 --Amount of recoil to directly apply to EyeAng
--Firing Cone Related
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed * 0.788 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
SWEP.ProjectileEntity = nil --Entity to shoot
SWEP.ProjectileVelocity = 0 --Entity to shoot's velocity
SWEP.ProjectileModel = nil --Entity to shoot's model
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_m590_olli.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m590_olli.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-1.990, -2, 1.15)
SWEP.IronSightsAng = Vector(-0.2, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.048+0.075, -4, -0.151)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.048+0.075, -4, -0.39+0.0375)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.048+0.075, -4, -0.391+0.0375)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.045+0.075, -3.5, -0.395)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.048+0.075, -3.5, -0.523)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-1.983+0.075, -3.5, -0.058)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(1,1,1), pos = Vector(0.075, 1, 0), angle = Angle(0, 0, 0) },
	["A_Modkit"] = { scale = Vector(1,1,1), pos = Vector(0.075, 1, 0), angle = Angle(0, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1,1,1), pos = Vector(0.0, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_m590_olli.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "A_Muzzle", rel = "", pos = Vector(50.583, 2.7, 2.331), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
