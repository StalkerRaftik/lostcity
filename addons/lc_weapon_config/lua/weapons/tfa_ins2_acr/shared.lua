...
SWEP.PrintName				= "ACR [Other Weapon]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.StaticRecoilFactor = 0.64 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--Movespeed
SWEP.MoveSpeed = 0.725 --Multiply the player's movespeed by this.
