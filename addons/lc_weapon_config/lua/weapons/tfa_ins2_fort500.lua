...
SWEP.PrintName				= "Fort-500 [Second SR]"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 1.56 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 1.00 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.9 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 2.15 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related2
