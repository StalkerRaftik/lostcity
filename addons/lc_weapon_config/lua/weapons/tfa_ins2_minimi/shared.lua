...
SWEP.PrintName				= "Minimi Para [FBI Weapon]"		-- Weapon name (Shown on HUD)
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.4 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
...
SWEP.IronSightsPos_EOTech = Vector(-2.684, -2.113, -0.012)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.684, -2.113, -0.013)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.681, -2.113, -0.016)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.684, -1.5, -0.433)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.608, -1.5, 0.116)
