SWEP.Gun					= ("tfa_win92") --Make sure this is unique.  Specically, your folder name.
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "LostCity Weapon Second SR" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "Winchester Repeating Arms Company" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "Winchester 1873 [Second SR]"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/winchester73/win_1873.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.FireModeName = "lever-action" --Change to a text value to override it
...
--Recoil Related
SWEP.Primary.KickUp			= 1.73-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.62					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.23					-- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 1.95 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.

--Firing Cone Related

SWEP.Primary.Spread		= .013					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0016	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/v_win73.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/w_win73.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(6.632, 0, 0) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-9.849, 27.437, -7.035) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-3.151, -2, 1.549) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

--[[INSPECTION]]--

SWEP.InspectPos = Vector(11.859, 0, 2.612) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(9.848, 35.175, 13.366) --Replace with a vector, in style of ironsights angle, to be used for inspection
