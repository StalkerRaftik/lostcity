...
SWEP.PrintName				= "B&T MP9 [MEDUSA Weapon]"		                   -- Weapon name (Shown on HUD)
SWEP.Manufacturer 			= "Brügger & Thomet"               -- Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Purpose				= "An 9x19mm Tactical Subcompact Submachine gun."
SWEP.Instructions			= ""              
...
SWEP.Primary.KickDown              = 0.282                     -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal        = 0.285                     -- This is the maximum sideways recoil (no real term)
...
-- Firing Cone Related
SWEP.Primary.Spread                = 0.045                     -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.VMPos          = Vector(-0.2, 0, 0.5)                     -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
