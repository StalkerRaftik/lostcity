...
SWEP.PrintName				= "MP7 [Third SR]"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.67 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.39 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.265 -- This is the maximum sideways recoil (no real term)
...
SWEP.IronSightsPos_Kobra = Vector(-2.823, -2, 0.142)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 56

SWEP.IronSightsPos_EOTech = Vector(-2.823, -2, 0.127)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 56

SWEP.IronSightsPos_RDS = Vector(-2.822, -2, 0.126)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 52

SWEP.IronSightsPos_2XRDS = Vector(-2.82, -4, 0.124)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 48

SWEP.IronSightsPos_C79 = Vector(-2.8215, -4, -0.229)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 58

SWEP.IronSightsPos_PO4X = Vector(-2.7577, -4, 0.238)
