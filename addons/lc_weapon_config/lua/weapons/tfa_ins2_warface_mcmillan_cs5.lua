...
SWEP.PrintName				= "McMillan CS5 [DWZ Weapon]"	              -- Weapon name (Shown on HUD)
SWEP.Manufacturer           = "McMillan Rifles"               -- Gun Manufactrer (e.g. Hoeckler and Koch )          
SWEP.Type                   = "Bolt-Action Sniper Rifle"
SWEP.Purpose				= "An 7.62x51MM Subsonic Integrally Suppressed Bolt Action Sniper Rifle."   
SWEP.Instructions		    = ""    
...
SWEP.IronSightsMoveSpeed         = 0.725                       -- Multiply the player's movespeed by this when sighting.
...
SWEP.VMPos                 = Vector(-1.15, 0, 0)              -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos_2XRDS     = Vector(-3.63, -3.25, 0.23)
...
SWEP.Attachments = {
	...
	[3] = { atts = { "ins2_br_heavy", } },
	[4] = { atts = { "tfa_tactical_point_shooting" } },
	[5] = { atts = { "am_match", "am_magnum", "am_gib" } },
	[6] = { atts = { "warface_mcmillan_cs5_fortune_skin", "warface_mcmillan_cs5_gold_skin" } },
}
