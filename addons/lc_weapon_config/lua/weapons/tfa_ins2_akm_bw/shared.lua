...
SWEP.PrintName				= "АК-47(Повреждён) [First SR]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Semi = 570 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.Spread		= .00053	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .00043 -- Ironsight accuracy, should be the same for shotguns\
...
SWEP.Primary.StaticRecoilFactor = 0.75 --Amount of recoil to directly apply to EyeAngl
...
--Movespeed
SWEP.MoveSpeed = 0.77 --Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.69 --Multiply the player's movespeed by this when sighting.
