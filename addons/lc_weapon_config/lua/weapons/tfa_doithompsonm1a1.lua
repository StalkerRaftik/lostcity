...
SWEP.PrintName				= "Thompson M1A1 [DWZ Weapon]"		-- Weapon name (Shown on HUD)
...
SWEP.WorldModel				= "models/weapons/tfa_doi/w_thompsonm1a1.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.KickUp				= 0.72				-- Maximum up recoil (rise)
