...
SWEP.Gun = ("tfa_nam_sawed_off_shotty") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Обрез Winchester Model 21 [First SR]"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.StaticRecoilFactor = 2 --Amount of recoil to directly apply to EyeAngl
...
SWEP.Primary.Spread		= .135	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .135 -- ironsight accuracy, should be the same for shotguns
...
SWEP.Attachments = {
                        [2] = { offset = { 0, 0 }, atts = { "sg_slug", "sg_frag", "amno_flechette" }, order = 3 },
}
...
SWEP.WElements = {
	["world_model"] = { type = "Model", model = SWEP.WorldModel, bone = "oof", rel = "", pos = Vector(3.484, 0.786, -1.686), angle = Angle(-168.099, -180, 0), size = Vector(0.944, 0.944, 0.944), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true }
}