...
SWEP.PrintName				= "M9 [Third SR]"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.788 -- This is the maximum upwards recoil (rise)
...
--Firing Cone Related
SWEP.Primary.Spread = .0008 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
