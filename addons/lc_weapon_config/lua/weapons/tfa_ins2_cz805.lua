...
SWEP.PrintName				= "CZ 805 [Other Weapon]"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.StaticRecoilFactor = 0.82 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.685 --Multiply the player's movespeed by this when sighting.
--[[PROJECTILES]]--
...
SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
