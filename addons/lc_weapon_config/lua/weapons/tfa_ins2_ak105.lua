...
SWEP.PrintName				= "AK-105 [Third SR]"		-- Weapon name (Shown on HUD)
...
--Firing Cone Related
SWEP.Primary.Spread = .0012 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_ak105.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_ak105.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.29, 0.8, 0.75)
