...
hook.Add("TFAAttachmentsLoaded", "!TFA_INS2_HoloSights", function()
	...
	if not render.SupportsPixelShaders_1_4() or not render.SupportsPixelShaders_2_0() or not render.SupportsVertexShaders_2_0() then
		...
		TFA.INS2.AddHoloSightType("sight_pk122", "models/weapons/tfa_ins2/optics/pk122_dot", 0, 0.075, "A_RenderReticle")
	...
	TFA.INS2.AddHoloSightType("sight_pk122", "models/weapons/tfa_ins2/optics/pk122_dot", 7, 0.23, "A_RenderReticle")
end)