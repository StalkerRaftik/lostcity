...
ATTACHMENT.Name = "M16 A1 Conversion"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = {TFA.AttachmentColors["="], "M16 A1 Conversion"}
ATTACHMENT.Icon = "entities/ar15_m16a1.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
function ATTACHMENT:Attach(wep)
	wep.VElements["r6s_suppr"].pos = Vector(0, -26.843, 1.187)
end
