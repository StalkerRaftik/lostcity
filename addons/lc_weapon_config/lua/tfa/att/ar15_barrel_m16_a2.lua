...
ATTACHMENT.Name = "M16A2 Conversion"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = {TFA.AttachmentColors["="], "M16A2 Conversion"}
ATTACHMENT.Icon = "entities/ar15_m16a2.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "M16A2"
...
function ATTACHMENT:Attach(wep)
	wep.VElements["r6s_suppr"].pos = Vector(0, -26.985, 1.187)
end
