...
ATTACHMENT.Description = {TFA.AttachmentColors["="], ".45 Magazines", TFA.AttachmentColors["+"],"15% More Damage", TFA.AttachmentColors["+"],"50% More Ammo", TFA.AttachmentColors["-"], "More Horizontal Spread", TFA.AttachmentColors["-"], "More Vertical Spread" }
...
ATTACHMENT.WeaponTable = {
		["Primary"] = {
		        ["RPM"] = function( wep, stat) return wep.Primary.RPM_45 or stat end,
                ["ClipSize"] = function( wep, stat) return wep.Primary.ClipSize_45 or stat end,
