...
ATTACHMENT.Description = {TFA.AttachmentColors["="], ".308 Magazines", TFA.AttachmentColors["+"],"50% More Damage", TFA.AttachmentColors["-"],"62.5% Less Ammo", TFA.AttachmentColors["+"], "Less Horizontal Spread", TFA.AttachmentColors["-"], "More Vertical Spread" }
