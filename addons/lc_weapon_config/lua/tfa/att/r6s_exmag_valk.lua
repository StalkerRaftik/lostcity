...
ATTACHMENT.Description = {TFA.AttachmentColors["="], "Extended Magazines", TFA.AttachmentColors["+"],"15 More Bullets", TFA.AttachmentColors["-"], "More Horizontal Spread", TFA.AttachmentColors["-"], "More Vertical Spread", TFA.AttachmentColors["-"], "Lower Movement Speed" }
...
ATTACHMENT.WeaponTable = {
	["VElements"] = {	
		...
		["Primary"] = {
				["ClipSize"] = function( wep, stat ) return stat + 15 end,	
