...
ATTACHMENT.Description = {TFA.AttachmentColors["="], ".556 Magazines", TFA.AttachmentColors["-"],"5% Less Damage", TFA.AttachmentColors["-"],"80% Less Ammo", TFA.AttachmentColors["+"], "Less Horizontal Spread", TFA.AttachmentColors["+"], "Less Vertical Spread", TFA.AttachmentColors["+"], "Faster Spread Recover" }
...
ATTACHMENT.WeaponTable = {
		["Primary"] = {
				...
				["SpreadRecovery"] = function( wep, stat ) return stat * 2 end,								
		}	
	}
