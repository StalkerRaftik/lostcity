...
ATTACHMENT.Description = {TFA.AttachmentColors["="], "6x zoom", TFA.AttachmentColors["-"], "20% higher zoom time"}
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_ACOG_3 or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_ACOG_3 or val, true end,
