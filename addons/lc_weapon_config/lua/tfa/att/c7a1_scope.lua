...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_C7A1 or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_C7A1 or val, true end,
