...
local zoom = 15 --Your desired scope zoom
local fov = 70 / zoom / 2 --Put this at the top; RT FOV

ATTACHMENT.Name = "Scope"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "15x zoom", TFA.AttachmentColors["-"], "30% higher zoom time"}
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_ACOG_M or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_ACOG_M or val, true end,
...
local myret = Material("scope/gdcw_nvgilluminatedduplex")
