...
ATTACHMENT.Name = "Shortdot"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "3.4x Zoom", TFA.AttachmentColors["-"], "20% Higher Zoom Time"}
ATTACHMENT.Icon = "entities/shortdot.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "Shortdot"
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_Shd or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_Shd or val, true end,
