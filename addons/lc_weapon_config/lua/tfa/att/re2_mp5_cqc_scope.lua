...
ATTACHMENT.Name = "CQC Scope"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "2x zoom", TFA.AttachmentColors["-"], "25% higher zoom time"}
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_CQC or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_CQC or val, true end,
