...
RainStorm.DataCalculationFunctions.StarFade = function( flPercent ) return 1 end
RainStorm.DataCalculationFunctions.SunSize = function( flPercent ) return 1 end
RainStorm.DataCalculationFunctions.MoonVisibility = function( flPercent ) return 1 end
