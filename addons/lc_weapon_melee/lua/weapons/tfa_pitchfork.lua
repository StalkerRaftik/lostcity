...
if killicon and killicon.Add then
	killicon.Add("tfa_pitchfork", "vgui/hud/kill/tfa_pitchfork", hudcolor)
end
...
if IsMounted( "left4dead2" ) then
	...
	SWEP.PrintName = "Вилы [Edged Weapons]"
	SWEP.Manufacturer = "L4D2 Community Update Team"
	SWEP.ViewModel = "models/weapons/melee/v_pitchfork.mdl"
	SWEP.ViewModelFOV = 60 -- L4D2 default is 51
	SWEP.VMPos = Vector(-1, -2, -1)
	SWEP.UseHands = true
	SWEP.CameraOffset = Angle(0, 0, 0)
	SWEP.WorldModel = "models/weapons/melee/w_pitchfork.mdl"
