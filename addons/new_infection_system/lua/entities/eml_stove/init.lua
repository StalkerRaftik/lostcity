...
local traceFire4 = util.TraceLine(traceF4);
	...
	if ((!self.nextHeat or CurTime() >= self.nextHeat) and (self:GetNWInt("gasStorage")>0)) then	
		if IsValid(traceFire1.Entity) then	
			...
			or (((traceFire1.Entity:GetClass() == "eml_pot2") and ((traceFire1.Entity:GetNWInt("1")>0) and (traceFire1.Entity:GetNWInt("2")>0))))
		...
		if IsValid(traceFire2.Entity) then	
			...
			or (((traceFire2.Entity:GetClass() == "eml_pot2") and ((traceFire2.Entity:GetNWInt("1")>0) and (traceFire2.Entity:GetNWInt("2")>0))))
		...
		if IsValid(traceFire3.Entity) then	
			...
			or (((traceFire3.Entity:GetClass() == "eml_pot2") and ((traceFire3.Entity:GetNWInt("1")>0) and (traceFire3.Entity:GetNWInt("2")>0))))
		...
		if IsValid(traceFire4.Entity) then	
			...
			or (((traceFire4.Entity:GetClass() == "eml_pot2") and ((traceFire4.Entity:GetNWInt("1")>0) and (traceFire4.Entity:GetNWInt("2")>0))))
