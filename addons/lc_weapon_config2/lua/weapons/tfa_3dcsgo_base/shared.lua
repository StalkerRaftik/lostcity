...
local cv_cc_r = GetConVar("cl_tfa_csgo_reticule_r")
local cv_cc_g = GetConVar("cl_tfa_csgo_reticule_g")
local cv_cc_b = GetConVar("cl_tfa_csgo_reticule_b")
local cv_cc_a = GetConVar("cl_tfa_csgo_reticule_a")
