...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrspecials/brute.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 500 
...
if math.random(1,1) == 1 then
        self:VJ_ACT_PLAYACTIVITY("nz_taunt_1",true,3,true)
    end
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnInitialize() 
	self:SetModel( Model("models/vj_lnrspecials/brute.mdl") ) 
