...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrspecials/nh2/Security01_shield.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 250 
...
ENT.ItemDropsOnDeath_EntityList = {"weapon_stunstick","item_ammo_ar2","item_ammo_pistol","item_ammo_smg1","item_box_buckshot","weapon_frag","item_rpg_round","item_ammo_crossbow"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
ENT.TurningSpeed = 10
ENT.AnimTbl_IdleStand = {"shield_nz_pacified_5"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnInitialize()
		...
		self.ZombieShield:SetModel("models/weapons/riotshield/shield.mdl")
...
function ENT:CustomOnThink_AIEnabled()		
		self.AnimTbl_Walk = {self:GetSequenceActivity(self:LookupSequence("shield_nz_walk_ad4"))}
		self.AnimTbl_Run = {self:GetSequenceActivity(self:LookupSequence("shield_nz_walk_ad4"))} 
