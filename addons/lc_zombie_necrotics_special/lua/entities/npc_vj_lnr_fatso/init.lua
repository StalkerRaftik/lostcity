...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrspecials/fatty.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200 
...
function ENT:CustomOnInitialize() 
	...
	if GetConVarNumber("vj_npc_noidleparticle") == 0 then		
		...
		eyeglow2:SetKeyValue("spawnflags","1") -- If animated
		eyeglow2:SetParent(self)
		eyeglow2:Fire("SetParentAttachment","eye1",0)
		eyeglow2:Spawn()
		eyeglow2:Activate()
		self:DeleteOnRemove(eyeglow2)
