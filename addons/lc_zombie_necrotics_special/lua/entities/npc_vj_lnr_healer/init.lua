...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrspecials/healer.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 150 
...
ENT.SoundTbl_MedicReceiveHeal = {"physics/flesh/flesh_bloody_break.wav"}
ENT.SoundTbl_MedicAfterHeal = {"physics/flesh/flesh_bloody_break.wav"}
-------------------------------------------------------------------------------------------------------------------
