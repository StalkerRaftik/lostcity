ENT.Base 			= "npc_vj_l4d2_tank" -- List of all base types: https://github.com/DrVrej/VJ-Base/wiki/Base-Types
ENT.Type 			= "ai"
ENT.PrintName 		= "Tank"
ENT.Author 			= "Darkborn"
...
function ENT:SetupDataTables()
	self:NetworkVar("Bool",0,"CanPlayMusic")
end

if CLIENT then
	net.Receive("vj_l4d2_tank_hud",function(len,pl)
		local delete = net.ReadBool()
		local ent = net.ReadEntity()
		if !IsValid(ent) then delete = true end
		hook.Add("HUDPaint","VJ_L4D2_Tank_HUD",function()
		...
		if delete == true then hook.Remove("HUDPaint","VJ_L4D2_Tank_HUD") end
	...
	function ENT:Initialize()
		self.Track = math.random(1,3) == 1 && "vj_lnrhl2/mapspawner/the_bigger_they_are.mp3" or "vj_lnrhl2/mapspawner/downtown_panic.mp3" or "vj_lnrhl2/mapspawner/downtown_panic.mp3"
	end
