...
ENT.Zombie_HazamatBroken = false
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnTakeDamage_AfterDamage(dmginfo,hitgroup)
	if self.Zombie_HazamatBroken == false then
		self.Zombie_HazamatBroken = true
		VJ_EmitSound(self,{"vj_l4d_com/ceda/ceda_suit_deflate.wav","vj_l4d_com/ceda/ceda_suit_deflate_02.wav","vj_l4d_com/ceda/ceda_suit_deflate_03.wav"},self.PainSoundLevel,self:VJ_DecideSoundPitch(self.PainSoundPitch1,self.PainSoundPitch2))
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
