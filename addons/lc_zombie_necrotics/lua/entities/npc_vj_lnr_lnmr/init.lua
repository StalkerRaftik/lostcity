...
if GetConVarNumber("vj_LNR_Gib") == 1 then
	...
	if hitgroup == HITGROUP_HEAD && dmginfo:GetDamageForce():Length() > 800 then
		...
		bloodeffect:SetPos(self:GetAttachment(self:LookupAttachment("anim_attachment_head")).Pos)
		bloodeffect:SetAngles(self:GetAttachment(self:LookupAttachment("anim_attachment_head")).Ang)
		bloodeffect:SetParent(self)
		bloodeffect:Fire("SetParentAttachment","anim_attachment_head")
		bloodeffect:Spawn()
