...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrhl2/zombie_corpse.mdl"} 
...
self:SetSkin(math.random(0,1))
		self.AnimTbl_Walk = {self:GetSequenceActivity(self:LookupSequence("nz_napalm_walk_1","nz_napalm_walk_1","nz_napalm_walk_1"))}
		self.AnimTbl_Run = {self:GetSequenceActivity(self:LookupSequence("nz_napalm_walk_1","nz_napalm_walk_1","nz_napalm_walk_1"))}
end
---------------------------------------------------------------------------------------------------------------------------------------------
