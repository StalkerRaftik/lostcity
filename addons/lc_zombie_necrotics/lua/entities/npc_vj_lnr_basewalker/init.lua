...
-----------------------------------------------*/
ENT.Model = {"models/vj_lnrhl2/gman.mdl"} 
ENT.HasDeathAnimation = false
ENT.HasDeathRagdoll = false
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomInitialize()
self:VJ_ACT_PLAYACTIVITY("Infectiondeath",true,false)
self.GodMode = true
...
VJ_EmitSound(self,{"vj_lnrhl2/infectedturned.mp3"},40)
self.GodMode = false
...
self.GodMode = false
	...
	if GetConVarNumber("vj_npc_noidleparticle") == 0 && GetConVarNumber("vj_LNR_Eyes") == 1 then 
