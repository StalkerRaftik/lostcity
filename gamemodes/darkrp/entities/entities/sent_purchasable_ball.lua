...
ENT.PrintName = "Bouncy Ball (no eat)"
...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Float", 0, "BallSize", { KeyName = "ballsize", Edit = { type = "Float", min = self.MinSize, max = 30, order = 1 } } )
...
function ENT:Initialize()
	...
	self:SetBallColor( table.Random( t ) )
...
function ENT:Use(act)
	...
	self:SetBallColor( table.Random( t ) )
	self:SetBallSize(math.random(self.MinSize, self.MaxSize))
end
