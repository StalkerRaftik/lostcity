		...
		cam.Start3D2D(pos + ang:Up(), Angle(0, LocalPlayer():EyeAngles().y-90, 90), 0.15);
				if (self:GetDTInt(1) == 0) then
					if self:GetDTBool(3) then
						...
						draw.SimpleTextOutlined("Вы должны посадить семена на землю!", "foodFontSmall", 0, -50, Color(255, 200, 200, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));					
					end;
				...
				elseif (self:GetDTInt(1) == 2) then				
					draw.SimpleTextOutlined("Время до сбора.", "foodFontSmall", 0, -476, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
				...
				elseif (self:GetDTInt(1) == 3) then				
					draw.SimpleTextOutlined("Готово к сбору!", "foodFontSmall", 0, -476, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));									
				end;			
		cam.End3D2D();
	end;
end;