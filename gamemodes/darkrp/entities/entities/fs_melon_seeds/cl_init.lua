	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < FS_DrawDistance then
		cam.Start3D2D(pos + ang:Up(), Angle(0, LocalPlayer():EyeAngles().y-90, 90), 0.15);
				if (self:GetDTInt(1) == 0) then
					draw.SimpleTextOutlined("Melon Seeds", "foodFont", 0, -74, FS_Melon_Color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
				...
				elseif (self:GetDTInt(1) == 1) then				
					draw.SimpleTextOutlined("Melon Plant", "foodFont", 0, -74, FS_Melon_Color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
				...
				elseif (self:GetDTInt(1) == 2) then				
					draw.SimpleTextOutlined("Melon Plant", "foodFont", 0, -194, FS_Melon_Color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
					draw.SimpleTextOutlined("Time until next harvest.", "foodFontSmall", 0, -170, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
				...
				elseif (self:GetDTInt(1) == 3) then				
					draw.SimpleTextOutlined("Melon Plant", "foodFont", 0, -194, FS_Melon_Color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));
					draw.SimpleTextOutlined("You can harvest now!", "foodFontSmall", 0, -170, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(25, 25, 25, 100));									
				end;			
		cam.End3D2D();
	end;
end;