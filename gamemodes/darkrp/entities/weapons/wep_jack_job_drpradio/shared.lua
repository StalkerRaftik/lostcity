...
elseif(CLIENT)then
	...
	function SWEP:DrawHUD()
		...
		draw.SimpleTextOutlined("Частота: "..ChanTxt,"rp.ui.24",W,H*.75,Color(255,255,255,255),TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
		draw.SimpleTextOutlined("Чтобы говорить в рацию, держите её в руках","rp.ui.20",W,H*.79,Color(255,255,255,255),TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
		draw.SimpleTextOutlined("Убрав рацию из рук, вас не будет слышно, но вы будете слышать других на частоте","rp.ui.20",W,H*.82,Color(255,255,255,255),TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
	end
end
