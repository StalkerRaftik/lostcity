...
function SWEP:DrawHUD()
    draw.WordBox(2, 10, ScrH() / 2, "ЛКМ на кейпад, чтобы узнать к какой двери он относится", "font_base_18", Color(0,0,0,120), Color(255, 255, 255, 255))
    draw.WordBox(2, 10, ScrH() / 2 + 20, "ЛКМ на предмет, чтобы узнать к каким кейпадам он относится", "font_base_18", Color(0,0,0,120), Color(255, 255, 255, 255))
    draw.WordBox(2, 10, ScrH() / 2 + 40, "ЛКМ - Очистить", "font_base_18", Color(0,0,0,120), Color(255, 255, 255, 255))
