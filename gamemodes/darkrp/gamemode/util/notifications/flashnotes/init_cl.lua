...
function PANEL:SetInfo(title, text)
	...
	text = string.Wrap('rp.ui.18', text, w - 10)
...
function PANEL:Paint(w, h)
	draw.RoundedBoxOutlined( 2, 0, 0, w, h, Color(58, 60, 69, 200), Color(20,20,20,150) )
  draw.RoundedBoxOutlined( 2, 0, 0, w, 25, Color(48, 50, 59, 200), Color(20,20,20,150) )
end
...
local function FlashNotify(title, text)
	...
	note:SetInfo("Городские новости", text)
