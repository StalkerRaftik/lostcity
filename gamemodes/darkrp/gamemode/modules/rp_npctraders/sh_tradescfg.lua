...
rp.Traders.Config = {
	["trader1"] = { -- ID продавца
		...
		itemsforbuy = {
			...
			ins2_br_heavy = 40,
			ar15_m16_barrel = 120,
			ar15_magpul_barrel = 130,
			ar15_ris_barrel = 110,
			ar15_ext_ris_barrel = 120,

			--Гильзы [Каркас патрона]
			['12_bullet_raw'] = 10,
			['308_bullet_raw'] = 30,
			['357_bullet_raw'] = 10,
			['45_acp_bullet_raw'] = 10, 
			['545_39_bullet_raw'] = 20,
			['556_45_bullet_raw'] = 20,
			['762_54_bullet_raw'] = 20,
			['9_19_bullet_raw'] = 10,
			['arrow_raw'] = 10,

			-- Снаряды [Патроны и т.д]
			tfa_rustalpha_ammo_arrow = 60,
			tfa_rustalpha_ammo_handmade_shell = 100,
			tfa_ammo_buckshot = 120,
			tfa_ammo_sniper_rounds = 200,
			tfa_ammo_357 = 130,
			tfa_ammo_pistol = 90,
			tfa_ammo_winchester = 140,
			tfa_ammo_ar2 = 150, 
			tfa_ammo_ar1 = 140,
			tfa_ammo_smg = 120,
			tfa_ammo_smg1_grenade = 300,
