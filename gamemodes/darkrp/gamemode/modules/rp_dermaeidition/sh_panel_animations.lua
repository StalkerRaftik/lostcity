...
function rp.Interface.InstallAnimationMethods(meta)
	...
	function meta:CreateAnimation(length, data)
		...
		if (length == 0 or (!animation.bIgnoreConfig and disableAnimations)) then
...
if (CLIENT) then
	...
	rp.Interface.InstallAnimationMethods(panelMeta)
end
