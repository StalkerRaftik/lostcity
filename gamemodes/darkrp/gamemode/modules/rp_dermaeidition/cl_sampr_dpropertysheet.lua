...
-- local arrow_left = Material("materials/samprp/icons/back.png", "noclamp smooth")
-- local arrow_right = Material("materials/samprp/icons/back.png", "noclamp smooth")
...
function PANEL:Setup( label, pPropertySheet, pPanel, strMaterial )
  ...
  if ( strMaterial ) then
    ...
    self.Image.Paint = function(self, w, h)
      ...
      surface.SetMaterial( Material(strMaterial, "noclamp smooth") )
...
function PANEL:Init()
  ...
  function self.tabScroller.btnLeft:Paint( w, h )
    -- draw.RoundedBox( 0, 0, 0, w, h, Color( 200, 100, 0 ) )
    -- surface.SetMaterial(arrow_left)
    -- surface.SetDrawColor(color_white)
    -- surface.DrawTexturedRect(0,0,w,h)
    draw.ShadowSimpleText("<", "font_base_big", 5, 5, Color(0, 0, 0), 0, 1)
    draw.ShadowSimpleText("<", "font_base_big", 5, 5.1, Color(255, 255, 255), 0, 1)
  end
  function self.tabScroller.btnRight:Paint( w, h )
    -- draw.RoundedBox( 0, 0, 0, w, h, Color( 0, 100, 200 ) )
    -- surface.SetMaterial(arrow_right)
    -- surface.SetDrawColor(color_white)
    -- surface.DrawTexturedRect(0,0,w,h)
    draw.ShadowSimpleText(">", "font_base_big", 0, 5, Color(0, 0, 0), 1, 1)
    draw.ShadowSimpleText(">", "font_base_big", 0, 5.1, Color(255, 255, 255), 1, 1)
...
derma.DefineControl( "SPropertySheet", "", PANEL, "Panel" )
