...
function PANEL:Init()
  ...
  local paintBtnUp = function( p, intW, intH )
    if p.Depressed then
      surface.SetTextColor( 55, 55, 55, 200 )
    elseif p.Hovered then
      surface.SetTextColor( 100, 100, 100, 150 )
    else
      surface.SetTextColor( 80, 80, 80, 150 )
    end
    surface.SetFont( "Marlett" )
    surface.SetTextPos( intW/3.05, 0 )
    surface.DrawText( "5" )
  end

  local paintBtnDown = function( p, intW, intH )
    if p.Depressed then
      surface.SetTextColor( 55, 55, 55, 200 )
    elseif p.Hovered then
      surface.SetTextColor( 100, 100, 100, 150 )
	...
	self.VBar.btnUp.Paint = paintBtnUp
	self.VBar.btnDown.Paint = paintBtnDown
	
	self.VBar.btnGrip.Paint = function( p, intW, intH )
		local col
    if p.Depressed then
			col = Color( 70, 70, 70, 200 )
		elseif p.Hovered then
			col = Color( 130, 130, 130, 175 )
		else
			col = Color( 120, 120, 120, 175 )
		end
    draw.RoundedBox(5,intW/2.1,0,intW/2.1,intH,col)
	end
